...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>LancerShelf | Hire freelancers and artisans Online</title>
		<!-- start: META -->
...
body,h1,h2,h3,h4,h5 {
    font-family: "Emma bold", "Times New Roman", Times, serif;
		...
		<div id="app">
				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
						     ...
						     <!----- ACCOUNT FUNDS DROPDOWN --->
							 
							 <li class="dropdown">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<i class="ti-money"></i> <span>&#8358; 0.0.0k</span>
								</a>
								<ul class="dropdown-menu dropdown-light dropdown-messages dropdown-large">
									<li>
										<span class="dropdown-header"> Account funds</span>
									</li>
									<li>
										<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="assets/images/naira_pay.svg">
													<span class="media-body block no-margin"> Make a deposit to credit your Account<small class="block text-grey">Your account is current empty</small> </span>
												</a>
									</li>
									<li>
										<div class="drop-down-wrapper ps-container margin-left-20">
											Balance: <br>
											&#8358; 0.0.0k
									...
									<li>
									<a class="media list-group-item" href=""> Transaction History</a>
									</li>
									<li>
									<a class="media list-group-item" href=""> Cash Out </a>
									</li>
									<li class="view-all">
										<a href="#">
											See All
							...
							<div class="row">
								...
								<div class="col-sm-5">
									...
									<ul class="mini-stats pull-right">
										<li>
											<div class="text-blue"> 
												<span class="fa fa-5x fa-folder-open"> </span>
											</div>
											<div class="values text-blue">
												<strong class="text-blue">4</strong>
												<p class="text-small text-blue no-margin">
													Project
												</p>
											</div>
										</li>
										...
										<li>
											<div class="text-blue">
												<span class="fa fa-5x fa-briefcase" ></span>
											</div>
											<div class="values text-blue">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Create Projects</h2>
											<p class="text-small">
												Create a Project to hire freelancers
											</p>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Create Contest</h2>
											<p class="text-small">
												Post a Job with a bounty - Get a huge turn up.
											</p>
											<p class="cl-effect-1">
												<a href="#">
													view more
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-briefcase fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Get Hired</h2>
											<p class="text-small">
												Sell yourself - let Clients find you - bid for jobs.
											</p>
											<p class="links cl-effect-1">
												<a href= "#">
													view more
									...
									<div class="row">
											...
											<div class="panel panel-white no-radius" id="visits">
												<div class="panel-heading border-light">
													...
													<ul class="panel-heading-tabs border-light">
														...
														<li>
															<div class="rate">
																<i class="fa fa-caret-up text-primary"></i><span class="value">15</span><span class="percentage"> bids</span>
															</div>
														</li>
												...
												<div collapse="visits" class="panel-wrapper">
													<div class="panel-body">
														<div class="height-350">
															...
															<div class="margin-top-20 margin-left-20 margin-right-20">
																<div class="inline pull-center">
																	<p class="text-large">Oops! Looks like you are new around here</p>
																	<p>No activity on your feeds!</p>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-md-5 col-lg-4">
											<div class="panel panel-white no-radius">
												<div class="panel-heading border-light">
													<h4 class="panel-title"> Account Funds </h4>
												</div>
												<div class="panel-body">
												<br>
													<h3 class="inline-block no-margin">&#8358; 0.0.0k</h3>
													<br><br>	<p>Click below to fund your Account</p>												
													<button class="btn btn-o btn-primary"><img class="img-circle" alt="..." src="assets/images/naira_pay.svg"></button>
													<br>
													<br>
									...
									<div class="panel panel-white no-radius">
										<div class="panel-body">
											<div class="partition-light-grey padding-15 text-center margin-bottom-20">
												<h4 class="no-margin">Jobs With My Skill</h4>
												<span class="text-light">based on your saved skills</span>
											</div>
												...
												<div class="panel no-radius">
													<div class="panel-heading">
														...
														<a href="#collapseOne" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle padding-15">
															...
															Web Design <span class="label label-danger pull-right">3</span>
														</a></h4>
													</div>
															...
															<table class="table">
																<tbody>
																	<tr>
																		...
																		<td>Redesign My Website</td>
																		<td class="center">&#8358; 45k - 60k</td>
																		<td><i class="fa fa-caret-down text-red"></i></td>
																	</tr>
																	<tr>
																		<td class="center">2</td>
																		<td>Website For hotel</td>
																		<td class="center">&#8358; 450k - 600k</td>
																		<td><i class="fa fa-caret-up text-green"></i></td>
																	</tr>
																	<tr>
																		<td class="center">3</td>
																		<td>School Website</td>
																		<td class="center">&#8358; 150k - 300k</td>
																		<td><i class="fa fa-caret-up text-green"></i></td>
																	</tr>
																	<tr>
																		<td class="center">4</td>
																		<td>Need a Homepage</td>
																		<td class="center">&#8358; 20k - 45k</td>
																		<td><i class="fa fa-caret-down text-red"></i></td>
																	</tr>
																</tbody>
															</table>
														...
														<div class="panel-body no-padding partition-light-grey">
															<table class="table">
																<tbody>
																	<tr>
																		<td class="center">1</td>
																		<td>Need Android App</td>
																		<td class="center">&#8358; 420k - 500k</td>
																		<td><i class="fa fa-caret-up text-green"></i></td>
																	</tr>
																	<tr>
																		<td class="center">2</td>
			...
			<footer>
				<div class="footer-inner">
					<div class="pull-left">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> AlgoNet</span>. <span>All rights reserved</span>
					</div>
					<div class="pull-right">
		...
		<script>
			...
			Command: toastr[info]("Edit your profile details to have access to all our services", "Edit your profile")
