...
..span9{margin-left:-75px !important;}
</style>
					...
					<div class="content">
						...
						<div class="module" style="margin-top:55px;">
							...
							<div class="module-body">
								...
								$bids_edit_query = mysql_query("SELECT * FROM bids WHERE project_id = '".$project_id."' AND uid = '".$active_session_id."' ");
								while($bidRows = mysql_fetch_assoc($bids_edit_query)){
									...
									<input type="hidden" class="hidden" name="project_id"  value="'; if(isset($_REQUEST['id']) && !empty($_REQUEST['id'])){echo (int)$_REQUEST['id']; }  echo '">
												...
												<a href="#" class="btn btn-md btn-primary santaClickEdit">
									...
									echo '<div class="media stream" data-bid-id="'.$uid.'">
										...
										<div class="media-body">
											...
											echo '
												...
												<a href="#" class="btn btn-xs btn-danger report-bid santaReportSecret" id="Report_'.$uid.'">
