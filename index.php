						...
						<ul class="nav navbar-right">
							 ...
							 <li class="dropdown">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<i class="ti-money"></i> <span>&#8358; 360.015.67k</span>
								</a>
								...
								<div class="col-sm-5">
									...
									<ul class="mini-stats pull-right">
										...
										<li>
											...
											<div class="values">
												<strong class="text-dark">3</strong>
												<p class="text-small no-margin">
													Contest
												</p>
											</div>
										...
										<li>
											...
											<div class="values">
												<strong class="text-dark">48</strong>
												<p class="text-small no-margin">
													Jobs
												</p>
											</div>
									...
									<div class="row">
										...
										<div class="col-md-5 col-lg-4">
											<div class="panel panel-white no-radius">
												...
												<div class="panel-body">
													<h3 class="inline-block no-margin">&#8358; 360.015.67k</h3> 
													<br>
													<br>
												<button class="btn btn-wide btn-primary ladda-button" data-style="expand-right">
													<span class="ladda-label">Fund Account</span>
													<span class="ladda-spinner"></span><span class="ladda-spinner"></span>
													<div class="ladda-progress" style="width: 120px;"></div>
												</button>
