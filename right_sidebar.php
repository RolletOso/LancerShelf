...
echo '<div id="off-sidebar" class="sidebar">
										...
										<ul class="media-list">
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Solomon Mbak</h4>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Timothy Maxwell</h4>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Joe Akpan</h4>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Jeremaih Uforo</h4>
										...
										<ul class="media-list">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Udo Ekemini</h4>
														<span> Web Editor </span>
													</div>
												</a>
											</li>
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<div class="media-body">
														<h4 class="media-heading">Kenneth Seun</h4>
														<span> Senior Designer </span>
													</div>
												</a>
											</li>
