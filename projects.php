...
span.faded-2,panel-tools>a>span.badge{
	background-color:#9a776e !important;
		...
		<div id="app">
			...
			$test_query = mysql_query("SELECT * FROM Projects");
			while($rows = mysql_fetch_assoc($test_query)){
				...
				<div class="panel panel-white margin-left-0 filter marketing webdesign contentwriting" id="panel'.$id.'">
												...
												<div class="panel-heading">
													...
													<div class="panel-tools" >
														...
														<a data-original-title="Open for bids" data-toggle="tooltip" data-placement="top" class="btn btn-transparent btn-sm panel-close" href="#"><label class="pull-right label label-success margin-bottom-5">'.$status.'</label></a>
												...
												<br>
													...
													<div class="pull-right"> <a class="btn btn-danger btn-block-o btn-o" href="projects/project.php?id='.$id.'#bid"><i class="ti ti-new-window"></i>  Bid</a> </div>
												</div>
											</div>
